...
<body>
    ...
    <li><a href="#">按书名查询商品</a></li>
   	...
   	<form action="SearchBookName.jsp?uid=<%=request.getParameter("userid") %>" method="post">
    	<div class="formbody">
...
%>
        	<li class="paginItem"><a href="findBookName.jsp?page=<%=i %>&userid=<%=request.getParameter("userid") %>"><%=i %></a></li>
<%	
		}
%>
