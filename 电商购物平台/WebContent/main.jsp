...
<title>电商购物平台-首页</title>
<link rel="icon" type="image/x-icon" href="images/shoppingcart.ico" />
...
<frameset rows="88,*,31" cols="*" frameborder="no" border="0" framespacing="0">
  		<frame src="top.jsp?count=<%=request.getParameter("time") %>&uid=<%=request.getParameter("userid") %>" name="topFrame" scrolling="no" noresize="noresize" id="topFrame" title="topFrame" />
  		<frameset cols="187,*" frameborder="no" border="0" framespacing="0">
    		<frame src="left.jsp?count=<%=request.getParameter("time") %>" name="leftFrame" scrolling="no" noresize="noresize" id="leftFrame" title="leftFrame" />
